...
local DTM_Locale = {
    ["default"] = {
         ...
         ["configIntroTitle"] = "DiamondThreatMeter |cFF0099FF[Lulleh Edition]|r",
         ...
         ["configVersionYours"] = "You are using a modified |cFF0099FFLulleh|r version of DTM |cffffffff%s|r.",
